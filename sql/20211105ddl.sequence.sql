...
select piu_idx_seq.currval from dual;
-- 2. 학교 정보 입력
...
insert into phoneinfo_basic
        values (piu_idx_seq.nextval, '황의조', '010-2222-1111', 'h@gmail.com', 'SEOUL', sysdate);
desc phoneinfo_com;
insert into phoneinfo_com
        values (piu_idx_seq.nextval, 'NAVER', piu_idx_seq.currval);
