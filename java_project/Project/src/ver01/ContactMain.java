...
public class ContactMain {
	public static void main(String[] args) {
		...
		//인스턴스 생성 = > new 클래스이름 -> 클래스() 생성자 호출	//인스턴스contact1과 contact2를 생성
		Contact contact1 = new Contact("손흥민", "010-0000-0000", "son@gmail.com", "London", "2021-10-22", "친구");
